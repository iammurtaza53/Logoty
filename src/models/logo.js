...
class Logo {
  ...
  serialize = () => {
    const {name, font, description, slogan, url, fontId, createdAt, id, icon, iconId, current, iconColor, textColor, bgColor,jprUrl,  svgUrl, pngUrl, transparentPngUrl,iconScale, fontSize, canvasWidth, iconLeft, iconTop, textLeft, textTop,svgEl , textScaleX, textScaleY, iconScaleX, iconScaleY, updatedAt} = this;
    return {name,font,  description, slogan, url, fontId, createdAt, id, icon, iconId, current, iconColor, textColor, bgColor , svgUrl, jprUrl, pngUrl, transparentPngUrl, iconScale, fontSize, canvasWidth, iconLeft, iconTop, textLeft, textTop , svgEl, textScaleX, textScaleY, iconScaleX, iconScaleY, updatedAt}
  }
